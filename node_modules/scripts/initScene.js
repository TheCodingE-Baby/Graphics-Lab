...
import { createProduct } from 'scripts/createProduct.js'; // Import the function to create the product model
import  'scripts/addLighting.js'; // Import the function to add lighting
import { updateCameraRotation } from 'scripts/camerAnimation.js'; // Import the camera animation script
import 'scripts/interaction.js'; // Import the interaction script for mouse events
